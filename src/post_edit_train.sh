...
PYTHONPATH=.. accelerate launch /home/gaya/group1/OLDS/src/main.py \
    -do_edit_train True \
    -seed 1 \
    -log_file logs/tweetsum_post_edit_train_bart.log \
    -output_dir models/post_edit_bart_large/tweetsum \
...
PYTHONPATH=.. accelerate launch /home/gaya/group1/OLDS/src/main.py \
    -do_edit_train True \
    -seed 1 \
    -log_file logs/tweetsum_post_edit_train_t5.log \
    -output_dir models/post_edit_t5_small/tweetsum \
    -dataset /home/gaya/group1/OLDS/data/tweetsumm/tweetsumm/omission.save \
    -model t5-small \
    -prefix summarize: \
    -max_source_length 512 \
...
PYTHONPATH=.. accelerate launch /home/gaya/group1/OLDS/src/main.py \
    -do_edit_train True \
    -seed 1 \
    -log_file logs/tweetsum_post_edit_train_t5_full_dial.log \
    -output_dir models/post_edit_t5_small_full_dial/tweetsum \
    -dataset /home/gaya/group1/OLDS/data/tweetsumm/tweetsumm/omission.save \
    -model t5-small \
    -prefix summarize: \
    -max_source_length 512 \

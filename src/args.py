...
def parse_args():
    ...
    parser.add_argument("-dataset", type=str, default='/home/gaya/group1/NLP_Final_Project/OLDS/data/qmsum')
    parser.add_argument("-max_source_length", type=int, default=1024)
    parser.add_argument("-max_target_length", type=int, default=128)
    parser.add_argument("-preprocessing_num_workers", type=int, default=1)
    parser.add_argument("-prefix", type=str, default="")
    parser.add_argument("-save_path", type=str, default='data/qmsum') # 원래는 data/samsum

    # omission dataset args
    parser.add_argument("-data_split_size", type=int, default=10)
    parser.add_argument("-domain", type=str, default='all',
        choices=[ "bart_base", "t5_base", "t5_small", "baseline", "pegasus", "all"] # removed "bart_large"
    )
    ...
    parser.add_argument("-output_attention_path", type=str, default='results/qmsum')
